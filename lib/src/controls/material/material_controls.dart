...
import 'package:gsy_video_player/src/controls/material/material_progress_bar.dart';
import 'package:gsy_video_player/src/controls/material/widgets/options_dialog.dart';
import 'package:gsy_video_player/src/controls/material/widgets/playback_speed_dialog.dart';
...
class _MaterialControlsState extends State<MaterialControls> with SingleTickerProviderStateMixin {
  ...
  late GsyVideoPlayerController controller;
  ...
  AnimatedOpacity _buildBottomBar(
    ...
    return AnimatedOpacity(
      ...
      child: Container(
        height: barHeight + (chewieController.videoPlayerController.value.isFullScreen ? 10.0 : 0),
        padding: EdgeInsets.only(
          left: 20,
          bottom: !chewieController.videoPlayerController.value.isFullScreen ? 10.0 : 0,
        ),
        child: SafeArea(
          top: false,
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                height: chewieController.videoPlayerController.value.isFullScreen ? 15.0 : 0,
              ),
  ...
  GestureDetector _buildMuteButton(
    GsyVideoPlayerController controller,
  ) {
