...
open class BiliDanmukuParser : BaseDanmakuParser() {
    ...
    public override fun parse(): Danmakus? {
        if (mDataSource != null) {
            ...
            try {
                ...
                val contentHandler: BiliDanmukuParser.XmlContentHandler = XmlContentHandler()
    ...
    inner class XmlContentHandler : DefaultHandler() {
        ...
        override fun startDocument() {
            result = Danmakus(ST_BY_TIME, false, mContext.baseComparator)
        }
        ...
        override fun startElement(uri: String?, localName: String, qName: String?, attributes: Attributes) {
            var tagName = localName.ifEmpty { qName!! }
            ...
            if (tagName == "d") {
                ...
                if (values.isNotEmpty()) {
                    ...
                    val color = (0x00000000ff000000L or parseLong(values[3]) and 0x00000000ffffffffL).toInt() // 颜色
        ...
        private fun decodeXmlString(input: String): String {
            var title = input
            if (title.contains("&amp;")) {
                title = title.replace("&amp;", "&")
            }
    ...
    companion object {
        ...
        init {
            System.setProperty("org.xml.sax.driver", "org.xml-pull.v1.sax2.Driver")
        }
    }
}